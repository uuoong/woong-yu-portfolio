import EmergeMaterial from "../stuff/EmergeMaterial.js"
import { useState, useEffect, useRef } from "react"
import gsap from "gsap"
import { useGSAP } from "https://cdn.jsdelivr.net/npm/@gsap/react@2.1.2/dist/index.min.js"
import { useLayoutEffect } from "react"
import * as THREE from "three"
import useScreenSize from "../stuff/useScreenSize.js"
import { OrbitControls, View } from "@react-three/drei"

import { useControls } from "https://cdn.jsdelivr.net/npm/leva@0.10.1/dist/leva.esm.min.js"
        ...
        <View {...props} ref={ref}>
            <mesh ref={setRefMesh}>
                <emergeMaterial
                    ...
                    uPixels={PIXELS}
                    uTextureSize={
                        new THREE.Vector2(textureSize[0], textureSize[1])
                    }
                    uElementSize={
                        new THREE.Vector2(elementSize[0], elementSize[1])
                    }
                />
