...
body:after {
    ...
    background-image: url(https://codrops.com/Tutorials/InfiniteAutoScrollingGallery/62f64d5233f6333080c87c81a9a35f9d.png);
...
.frame__demo--current,.frame__demo--current:hover,a {
...
export default function InfiniteVerticalGallery() {
    useEffect(() => {
        if (typeof window !== "undefined" && document) {
            document.documentElement.classList.remove("no-js")
            document.documentElement.classList.add("js")

            import("./gl/GL.js").then(({ default: GL }) => {
                const canvas = new GL("#gl")
                canvas.create()
            })
        }
    }, [])
                ...
                <div className="demo-1">
                    <div className="demo-1__gallery">
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=2"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=3"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=4"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=5"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=6"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=7"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=8"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=9"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=10"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=11"
                            />
                        </figure>
                        ...
                        <figure className="demo-1__gallery__figure">
                            <img
                                className="demo-1__gallery__image"
                                src="https://unsplash.it/1920/1080?random=12"
                            />
                        </figure>
                    </div>
                </div>
